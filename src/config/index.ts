import { type BlockchainConnection } from '..'
...
export interface BridgesConfig {
  ...
  /**
     ...
     * {@link BlockchainConnection.createUsingEncryptedJson} or {@link BlockchainConnection.createUsingPassphrase}. This configuration is optional because
